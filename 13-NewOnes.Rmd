...
## 144 Relative to 52 Weeks HighLow {-}
...
Several studies have indicated that after a given stock ranks at the top or bottom of all stocks (winners and losers), results in predicable patterns of price change during the following weeks.
