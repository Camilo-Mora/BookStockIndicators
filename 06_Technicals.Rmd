...
### Volatility and expected profits {--}
Do not ask from a stock what it cannot give you.

The final critical aspect for the best entry is to know if your desired profit take is within the  returns generated by an stock. Say a given stock has a yearly volatility of 5% and you want to get a 6% profit in your entry; basically, it will be years before you can secure that sort of profit from such an stock. An obvious recommendation is to aim for a profit take that is only a fraction of the stock's volatility.
