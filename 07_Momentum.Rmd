...
tradingview_embed_options.chart = 'xgi3fPuF';
new TradingView.chart(tradingview_embed_options);
</script>
<p><a href="https://www.tradingview.com/script/xgi3fPuF-001-APO/">001 APO</a> by <a href="https://www.tradingview.com/u/moracamilo/">moracamilo</a> on <a href="https://www.tradingview.com/">TradingView.com</a></p>
...
Count the largest number of consecutive red candles, lower highs, lower lows (descending trends) and green, higher highs and higher lows (ascending trend). Then it calculates the difference between the two, to determine which direction has the most strength.

It is expected that larger values in one direction will correlate with larger profit in the opposite direction, as there is just so much high a trend can go (basically, a correction due to extreme declines or increases).
...
```{r, out.width = "100%", echo= FALSE, fig.align = 'center',fig.cap = 'Lazy bearSqueeze'}
knitr::include_graphics("images/SqueezeLZ.png")
```
