...
## 06 BRAR {-}
This index is available in the Pandas library, but no information is provided on how it should be used.
...
```{r, out.width = "100%", echo= FALSE, fig.align = 'center',fig.cap = 'BRAR'}
knitr::include_graphics("images/brar.png")
```
...
This indicator compares the most recent close, to the highest difference in price over a prior period of time. 
...
The indicator is telling a trader where the current price is relative to the highest high over a prior period. It does helps to reveal tops and bootms.
